...
class MealTableViewController: UITableViewController {
    ...
    var meals = [Meal]()
    fileprivate lazy var fetchedResultController: NSFetchedResultsController<Meal> = {
        // Creat fetch request
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        guard let meals = fetchedResultController.fetchedObjects else {
            return 0
        }
        return meals.count
    }
    ...
    func configureCell(_ cell: MealTableViewCell, indexPath: IndexPath) {
        ...
        let meal = fetchedResultController.object(at: indexPath)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        case "ShowDetail":
            ...
            mealDetailViewController.meal = fetchedResultController.object(at: indexPath)
